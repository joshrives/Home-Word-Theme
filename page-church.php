<?php
/**
 * Template name: Church Leader Home
 *
...
get_header(); ?>
				...
				<div class="general-content group church-content">
...
<?php
	$args = array( 'post_type' => 'devotionals', 'posts_per_page' => 1, 'area' => 'church-leaders');
...
<?php
	$args = array( 'post_type' => 'post', 'posts_per_page' => 1, 'area' => 'church-leaders');
	$loop = new WP_Query( $args );
	while ( $loop->have_posts() ) : $loop->the_post();
?>
								<a href = "<?php the_permalink(); ?>">
